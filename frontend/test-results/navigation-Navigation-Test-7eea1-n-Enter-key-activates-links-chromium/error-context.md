...
- Name: navigation.spec.ts >> Navigation Tests >> Keyboard Navigation >> Enter key activates links
- Location: e2e/navigation.spec.ts:113:5
...
Call log:
  - waiting for getByRole('link', { name: /dokumenti/i }).first()

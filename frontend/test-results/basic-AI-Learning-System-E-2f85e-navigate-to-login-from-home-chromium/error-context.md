...
- Name: basic.spec.ts >> AI Learning System E2E Tests >> Navigation >> can navigate to login from home
- Location: e2e/basic.spec.ts:55:5
...
Call log:
  - waiting for getByRole('link', { name: /prijava|login|log in/i }).first()

...
- Name: navigation.spec.ts >> Navigation Tests >> Main Navigation >> navbar is visible on homepage
...
Locator: locator('nav, header').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('nav, header').first()

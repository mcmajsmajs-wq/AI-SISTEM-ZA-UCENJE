...
- Name: navigation.spec.ts >> Navigation Tests >> Main Navigation >> can navigate to quizzes
- Location: e2e/navigation.spec.ts:27:5
...
Call log:
  - waiting for getByRole('link', { name: /kvizovi|quizzes/i }).first()

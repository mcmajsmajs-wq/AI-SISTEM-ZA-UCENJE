...
4. Providing only the translation, no explanations"""
    ...
    def provider_name(self) -> str:
        return TranslationProvider.MISTRAL.value

    def is_available(self) -> bool:
        return bool(self.api_key) and self.api_key != "OPgrJtgklwx5SlZcgshWrPiC8jUEkOcj"

    def _calculate_cost(self, tokens: int) -> float:
        rate = self.COST_PER_1K_TOKENS.get(self.model, 0.00020)

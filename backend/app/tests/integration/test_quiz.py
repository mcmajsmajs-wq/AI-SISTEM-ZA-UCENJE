...
class TestQuizModel:
    ...
    def test_quiz_has_document_relationship(self, db: Session, test_quiz_ready: Quiz, test_document: Document):
...
class TestQuestionModel:
    def test_create_questions(self, db: Session, test_quiz_ready: Quiz):
        ...
        questions = db.query(Question).filter(Question.quiz_id == test_quiz_ready.id).all()
    ...
    def test_checkbox_answer_format(self, db: Session, test_quiz_ready: Quiz):
        ...
        checkbox_q = db.query(Question).filter(
...
class TestAnswerChecking:
    def test_multiple_choice_correct(self):
        ...
        assert QuizService._check_answer_static("multiple_choice", "Beograd", "Beograd") is True
    ...
    def test_multiple_choice_wrong(self):
        ...
        from app.services.quiz import QuizService
        assert QuizService._check_answer_static("multiple_choice", "Novi Sad", "Beograd") is False
    ...
    def test_checkbox_correct_same_order(self):
        ...
        from app.services.quiz import QuizService
        assert QuizService._check_answer_static("checkbox", "Python,Java", "Python,Java") is True

    def test_checkbox_correct_different_order(self):
        """Checkbox: različit redosled = tačno (set poređenje)."""
        from app.services.quiz import QuizService
        assert QuizService._check_answer_static("checkbox", "Java,Python", "Python,Java") is True

    def test_checkbox_wrong(self):
        """Checkbox: pogrešna kombinacija."""
        from app.services.quiz import QuizService
        assert QuizService._check_answer_static("checkbox", "Python,HTML", "Python,Java") is False

    def test_checkbox_partial(self):
        """Checkbox: parcijalan odgovor = pogrešno."""
        from app.services.quiz import QuizService
        assert QuizService._check_answer_static("checkbox", "Python", "Python,Java") is False

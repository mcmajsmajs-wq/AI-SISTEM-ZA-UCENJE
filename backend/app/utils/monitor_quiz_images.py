...
def check_quiz_images():
    ...
    result = subprocess.run(
        [
            ...
            "ai_learning_db",
            "-c",
            "SELECT LEFT(image_url, 50) as url_start, COUNT(*) FROM questions "  # noqa: E501
            "WHERE image_url IS NOT NULL GROUP BY LEFT(image_url, 50) LIMIT 5;",
        ],
        capture_output=True,
        text=True,
    )
    ...
    result = subprocess.run(
        [
            ...
            "-w",
            "%{http_code}",
            "http://localhost:8081/minio/ai-learning-uploads/quiz_images/"  # noqa: E501
            "f641e007-ac98-4c2e-abc3-42251016a79e/60335789-39cd-4e38-b8fd-853e24e64785.jpg",
        ],
        capture_output=True,
        text=True,
    )
    ...
    print("\n💡 7. Preporuke:")
    print(
        "   - Ako je 403: URL je istekao, API će regenerisati pri sledećem učitavanju"
    )
...
def check_all_quiz_issues():
    ...
    errors = {"500": [], "404": [], "NoneType": [], "image_url": [], "database": []}

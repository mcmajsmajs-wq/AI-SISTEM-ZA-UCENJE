...
class FileProcessingService:
    ...
    def _process_pdf(self, file_content: bytes, progress_callback=None) -> Dict[str, Any]:
        from app.services.pdf import PDFService

        pdf_service = PDFService(use_ocr=self.use_ocr, ocr_language=self.ocr_language)
        result = pdf_service.process_pdf(file_content, progress_callback=progress_callback)

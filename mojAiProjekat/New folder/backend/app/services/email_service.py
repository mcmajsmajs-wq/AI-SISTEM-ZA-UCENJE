...
class EmailService:
    ...
    def send_welcome(self, to: str, full_name: str) -> bool:
        ...
        html += "<p>Uspesno ste se registrovali u <strong>AI Sistem za ucenje</strong>.</p>"
    ...
    def send_daily_reminder(
        ...
        streak_html = f"<p>Trenutni streak: <strong>{streak} dan</strong> - ne prekidaj niz!</p>" if streak > 0 else ""
        html = "<div style='font-family:sans-serif;max-width:560px;margin:0 auto'>"
        html += f"<h2 style='color:#6366f1'>Zdravo, {name}!</h2>"
    ...
    def send_weekly_summary(
        ...
        subject = f"Nedeljni izvestaj - {'Cilj postignut!' if achieved else f'{pct}% cilja'}"
        best_html = f"<p>Najbolji kviz: <strong>{best_quiz}</strong></p>" if best_quiz else ""
        html = "<div style='font-family:sans-serif;max-width:560px;margin:0 auto'>"

...
from app.services.ai_chat import AIChatService, ChatMessage, MessageRole, AVAILABLE_TOOLS
...
async def chat(
    ...
    tools_enabled = any(tool_name in AVAILABLE_TOOLS[0]["function"]["name"] for tool_name in tool_names) if tool_names else True
